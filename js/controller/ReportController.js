...
reportApp.controller('ReportController',
    function ReportController($scope, $log, $route, $templateCache, $location, $window, SharedData) {
        var from;
        var until;
        ...
        $scope.sendDate = function() {
            ...
            } else if (_until.isFuture()){
                alert('리포트 종료 시점은 현재보다 앞 설수 없습니다!!');
            } else{
                $log.info("reportcontroller: "+from+" : "+ until);
